...
import { createEntrySchema, type EntryFormValues, type JournalTag } from '../validations/entry.schema';
...
export function Composer({ showVisibilityToggle = true }: ComposerProps) {
	...
	const { register, handleSubmit, reset, watch, setValue, formState } = useForm<EntryFormValues>({
	...
	return (
		<>
			...
			<div ref={wrapperRef} className="relative z-20 border-b border-border bg-card px-4 py-4">
