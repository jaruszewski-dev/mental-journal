...
import { createRegisterSchema, type RegisterFormValues } from '@/features/auth/register/validations/register.schema';
import {
	...
	return (
		<form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3" noValidate>
			...
			<p className="min-h-5 text-sm text-destructive" role="alert">
				{mutation.isError ? resolveApiErrorMessage(mutation.error, tApi) : '\u00a0'}
			</p>
