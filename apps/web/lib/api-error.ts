...
const API_ERROR_MESSAGE_KEYS: Record<string, string> = {
	...
	[ErrorCode.AUTH_VERIFICATION_TOKEN_NOT_FOUND]: 'AUTH_VERIFICATION_TOKEN_NOT_FOUND',
	[ErrorCode.AUTH_VERIFICATION_TOKEN_EXPIRED]: 'AUTH_VERIFICATION_TOKEN_EXPIRED',
	[ErrorCode.USER_ALREADY_EXISTS]: 'USER_ALREADY_EXISTS',
};

export function resolveApiErrorMessage(error: unknown, t: TranslateApiError, fallbackKey = 'generic'): string {
